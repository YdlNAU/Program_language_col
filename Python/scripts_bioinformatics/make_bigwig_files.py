...
def bed_graph_to_big_wig(in_bed_graph, genome, out_big_wig):
    priming_call = "LC_COLLATE=C sort -k1,1 -k2,2n " + in_bed_graph + "> tem_bg"
    subprocess.call(priming_call, shell=True)
    priming_call = "bedGraphToBigWig {} {} {}".format("tem_bg", genome, out_big_wig)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Makes Pretty bed Graph Files! Note: the out files are normalized pos and neg(inverted) bigwig!")
    ...
    parser.add_argument("--keep", help="whether keep the,all Temporary files, default True",default=False,) # Add by Yudalang
    ...
    bigWigFilePos = bedGraphFilePosNorm.replace(".bg", ".bw") # This variable is useless
    ...
    bigWigFileNegInverted = bedGraphFileNegNorm.replace(".bg", ".bw") # This variable is useless
    ...
    if args.keep:
        print "We create bedGraph files both before and after normaliza!"
    else:
        system_call = "rm {} {} {} {} {} {}".format( bedGraphFilePos,bedGraphFilePosNorm,bedGraphFileNeg,bedGraphFileNegNorm,bedGraphFileNegInverted,"tem_bg")
